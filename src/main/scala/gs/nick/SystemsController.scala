...
class SystemsController(systemsDao: SystemsDaoTrait)(implicit val ec: ExecutionContext) extends SystemsHandler {
  ...
  def getSystemList(
      respond: SystemsResource.getSystemListResponse.type)(): Future[SystemsResource.getSystemListResponse] = {
  ...
  def getSystemById(respond: SystemsResource.getSystemByIdResponse.type)(
      systemId: BigDecimal): Future[SystemsResource.getSystemByIdResponse] = {
  ...
  override def createSystem(respond: SystemsResource.createSystemResponse.type)(
      newSystem: WireSystem): Future[SystemsResource.createSystemResponse] = {
